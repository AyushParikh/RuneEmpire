 ...
 */
export function dealerDrawing(dealerHand, deck, playerHand, isSplit) {
  if ((!playerHand.isBust && !playerHand.hasBlackjack) || isSplit) {
    console.log(dealerHand.scoreStats);
    for (
      let stats = dealerHand.scoreStats;
      stats.hardTotal < 17 || stats.softTotal < 17;
